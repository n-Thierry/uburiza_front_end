    ...
    <div className="h-screen overflow-hidden flex flex-row-reverse bg-slate-50 transition-colors duration-300 font-sans">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-emerald-900 relative overflow-hidden flex-col justify-center p-12 order-2">
        ...
        <div className="relative z-10 max-w-md">
          ...
          <div className="bg-emerald-800/50 backdrop-blur-md p-6 rounded-2xl border border-emerald-700 text-left">
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                <div className="text-white text-sm font-bold">Jean-Claude N.</div>
                <div className="text-emerald-300 text-xs">Frontend Engineer</div>
              </div>
            </div>
          </div>
        </div>
